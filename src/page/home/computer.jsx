...
const Computers = () => {
  ...
  return (
    <div className="container mx-auto p-6  bg-gray-100 mt-2">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-yellow-600">Shop</h1>
        <div className="flex gap-4">
          <button className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-green-800">
            View All
          </button>
        </div>
      </div>
        ...
        <CarouselContent className="-ml-2 md:-ml-4">
          {products.map((product) => (
            <CarouselItem key={product.id} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/4">
              <div className=" rounded-lg hover:shadow-lg transition-shadow duration-300 bg-gray-300">
